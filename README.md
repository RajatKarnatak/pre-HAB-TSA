...
The script produces several analytical plots which include: (a) cluster validation indices, (b) dendrogram, (c) inter-event interval plots, (d) cluster transition probabilities, 
and (e) a folder adv_plots which contains a variety of pre-event time series plots.
